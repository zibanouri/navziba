...
//                     <div
//                         className="text-2xl font-bold bg-gradient-to-r text-gray-900 bg-clip-text"
//                     >
//                         Ziba Nouri
//                     </div>
...
//                             (item) => (
//                                 <button className="text-2xl font-bold text-gray-800 bg-clip-text">
//                                     {item}
...
//                             ].map((item) => (
//                                 <button
//                                    className="capitalize text-left py-2 hover:text-sky-300 transition-colors duration-300 font-medium cursor-pointer"
//                                 >
//                                     {item}
//                                 </button>
//                             ))}
